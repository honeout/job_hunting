...
public:
    ...
    // 魔法入力
    bool InputMagick(float elapsedTime);
    ...
    // 特殊技使えるか
    bool GetSpecialAction() const { return specialAction; }
...
public:
    ...
    // 特殊技の所持してるか
    bool GetSpecialAttack(int type) const { return specialAttack.at(type).hasSkill; }
...
private:
    ...
    float vignettePinchSmoothness = 2.0f;
    float vignettePinchIntensity = 0.3f;
