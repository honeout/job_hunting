...
#include "EnemyBoss.h"
#include "Projectile\ProjectileTornade.h"
#include "State\StateDerived.h"
#include "Component\TransForm2D.h"
#include "Projectile\ProjectileImpact.h"
#include "Projectile\ProjectileSunder.h"
...
// 魔法発射
bool Player::InputMagick(float elapsedTime)
{
    // Lockとして実体を使う
    auto mpId = mp.lock();
    auto modelControllId = modelControll.lock();
